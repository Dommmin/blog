...
'scout.typesense.client-settings.num_retries','scout.typesense.client-settings.retry_interval_seconds','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.0.name','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.0.type','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.1.name',
'scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.1.type','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.2.name','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.2.type','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.3.name','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.3.type',
'scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.4.name','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.4.type','scout.typesense.model-settings.App\\Models\\Post.collection-schema.default_sorting_field','scout.typesense.model-settings.App\\Models\\Post.search-parameters.query_by','scout.enabled',
...
'horizon.failed-jobs.index','horizon.failed-jobs.show','horizon.retry-jobs.show','horizon.jobs.show','horizon.index','locale.change','home','about','blog.index',
'blog.show','newsletter.subscribe','newsletter.confirm','admin.home',
'admin.categories.index','admin.categories.create','admin.categories.store','admin.categories.show','admin.categories.edit',
'admin.categories.update','admin.categories.destroy','admin.posts.index','admin.posts.create','admin.posts.store',
'admin.posts.show','admin.posts.edit','admin.posts.update','admin.posts.destroy','admin.tags.index',
'admin.tags.create','admin.tags.store','admin.tags.show','admin.tags.edit','admin.tags.update',
'admin.tags.destroy','profile.edit','profile.update','profile.destroy',
...
'VITE_APP_NAME','APP_AVAILABLE_LOCALES','SCOUT_QUEUE','SCOUT_DRIVER','TYPESENSE_API_KEY',
