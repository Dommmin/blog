...
'inertia.ssr.bundle','inertia.testing.ensure_pages_exist','inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt',
...
'logging.channels.daily.driver','logging.channels.daily.path','logging.channels.daily.level','logging.channels.daily.days','logging.channels.daily.channels',
...
'scout.typesense.client-settings.connection_timeout_seconds','scout.typesense.client-settings.healthcheck_interval_seconds','scout.typesense.client-settings.num_retries','scout.typesense.client-settings.retry_interval_seconds','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.0.name',
'scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.0.type','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.1.name','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.1.type','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.2.name','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.2.type',
'scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.3.name','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.3.type','scout.typesense.model-settings.App\\Models\\Post.collection-schema.default_sorting_field','scout.typesense.model-settings.App\\Models\\Post.search-parameters.query_by','scout.typesense.model-settings.App\\Models\\Post.search-parameters.query_by_weights',
'scout.typesense.model-settings.App\\Models\\Post.search-parameters.sort_by','scout.typesense.model-settings.App\\Models\\Post.search-parameters.filter_by','scout.typesense.model-settings.App\\Models\\Post.search-parameters.drop_tokens_threshold','scout.typesense.model-settings.App\\Models\\Post.search-parameters.typo_tokens_threshold','scout.typesense.model-settings.App\\Models\\Post.search-parameters.prefix',
'scout.enabled','sentry.dsn','sentry.release','sentry.environment','sentry.sample_rate',
...
'services.slack.notifications.channel','services.medium.token','session.driver','session.lifetime','session.expire_on_close',
...
'debugbar.theme','debugbar.debug_backtrace_limit','translation-manager.route.prefix','translation-manager.route.middleware','translation-manager.delete_enabled',
'translation-manager.exclude_groups','translation-manager.exclude_langs','translation-manager.sort_keys','translation-manager.trans_functions','translation-manager.db_connection',
...
'newsletter.confirm','newsletter.unsubscribe','blog.comments.store','blog.comments.destroy','register','login','password.request','password.email',
'password.reset','password.store','verification.notice','verification.verify','verification.send',
'password.confirm','logout','settings.redirect','profile.edit',
'profile.update','profile.destroy','password.edit','password.update','appearance',
'admin.home','admin.categories.index','admin.categories.create','admin.categories.store','admin.categories.show',
