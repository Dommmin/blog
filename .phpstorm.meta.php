...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\Contracts\CategoryRepositoryInterface' => \App\Repositories\CategoryRepository::class,
            'App\Repositories\Contracts\PostRepositoryInterface' => \App\Repositories\PostRepository::class,
            'App\Repositories\Contracts\TagRepositoryInterface' => \App\Repositories\TagRepository::class,
    ...
    override(\config(), map([
            ...
            'logging.channels.daily.channels' => 'array',
            ...
            'scout.typesense.model-settings.App\Models\Post.collection-schema.fields.0.name' => 'string',
            'scout.typesense.model-settings.App\Models\Post.collection-schema.fields.0.type' => 'string',
            'scout.typesense.model-settings.App\Models\Post.collection-schema.fields.1.name' => 'string',
            'scout.typesense.model-settings.App\Models\Post.collection-schema.fields.1.type' => 'string',
            'scout.typesense.model-settings.App\Models\Post.collection-schema.fields.2.name' => 'string',
            'scout.typesense.model-settings.App\Models\Post.collection-schema.fields.2.type' => 'string',
            'scout.typesense.model-settings.App\Models\Post.collection-schema.fields.3.name' => 'string',
            'scout.typesense.model-settings.App\Models\Post.collection-schema.fields.3.type' => 'string',
            'scout.typesense.model-settings.App\Models\Post.collection-schema.fields.4.name' => 'string',
            'scout.typesense.model-settings.App\Models\Post.collection-schema.fields.4.type' => 'string',
            'scout.typesense.model-settings.App\Models\Post.collection-schema.default_sorting_field' => 'string',
            'scout.typesense.model-settings.App\Models\Post.search-parameters.query_by' => 'string',
            'scout.typesense.model-settings.App\Models\Post.search-parameters.query_by_weights' => 'string',
            'scout.typesense.model-settings.App\Models\Post.search-parameters.sort_by' => 'string',
            'scout.typesense.model-settings.App\Models\Post.search-parameters.filter_by' => 'string',
            'scout.typesense.model-settings.App\Models\Post.search-parameters.drop_tokens_threshold' => 'integer',
            'scout.typesense.model-settings.App\Models\Post.search-parameters.typo_tokens_threshold' => 'integer',
            'scout.typesense.model-settings.App\Models\Post.search-parameters.prefix' => 'boolean',
            'scout.enabled' => 'boolean',
            'sentry.dsn' => 'string',
            'sentry.release' => 'NULL',
...
'viewHorizon','viewAny','view','create','update',
...
'filesystems.links./var/www/public/storage','horizon.domain','horizon.path','horizon.use','horizon.prefix',
...
'horizon.environments.production.supervisor-1.balanceMaxShift','horizon.environments.production.supervisor-1.balanceCooldown','horizon.environments.production.supervisor-1.tries','horizon.environments.local.supervisor-1.connection','horizon.environments.local.supervisor-1.queue',
'horizon.environments.local.supervisor-1.balance','horizon.environments.local.supervisor-1.processes','horizon.environments.local.supervisor-1.tries','inertia.ssr.enabled','inertia.ssr.url',
...
'logging.channels.daily.path','logging.channels.daily.level','logging.channels.daily.days','logging.channels.daily.channels','logging.channels.daily.replace_placeholders',
...
'scout.typesense.client-settings.healthcheck_interval_seconds','scout.typesense.client-settings.num_retries','scout.typesense.client-settings.retry_interval_seconds','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.0.name','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.0.type',
'scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.1.name','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.1.type','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.2.name','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.2.type','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.3.name',
'scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.3.type','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.4.name','scout.typesense.model-settings.App\\Models\\Post.collection-schema.fields.4.type','scout.typesense.model-settings.App\\Models\\Post.collection-schema.default_sorting_field','scout.typesense.model-settings.App\\Models\\Post.search-parameters.query_by',
'scout.typesense.model-settings.App\\Models\\Post.search-parameters.query_by_weights','scout.typesense.model-settings.App\\Models\\Post.search-parameters.sort_by','scout.typesense.model-settings.App\\Models\\Post.search-parameters.filter_by','scout.typesense.model-settings.App\\Models\\Post.search-parameters.drop_tokens_threshold','scout.typesense.model-settings.App\\Models\\Post.search-parameters.typo_tokens_threshold',
'scout.typesense.model-settings.App\\Models\\Post.search-parameters.prefix','scout.enabled','sentry.dsn','sentry.release','sentry.environment',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.medium.token','session.driver','session.lifetime',
...
'sitemap.crawl_profile','view.paths','view.compiled','broadcasting.default','broadcasting.connections.reverb.driver',
...
'debugbar.route_domain','debugbar.theme','debugbar.debug_backtrace_limit','translation-manager.route.prefix','translation-manager.route.middleware',
...
'translation-manager.db_connection','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'debugbar.queries.explain','horizon.stats.index','horizon.workload.index',
...
'api.user','blog.suggest-posts','home',
'locale.change','about','blog.index','blog.show','newsletter.subscribe',
'newsletter.confirm','blog.comments.store','register','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'logout','settings.redirect','profile.edit','profile.update','profile.destroy',
'password.edit','password.update','appearance','admin.home','admin.categories.index',
'admin.categories.create','admin.categories.store','admin.categories.show','admin.categories.edit','admin.categories.update',
'admin.categories.destroy','admin.posts.index','admin.posts.create','admin.posts.store','admin.posts.show',
'admin.posts.edit','admin.posts.update','admin.posts.destroy','admin.tags.index','admin.tags.create',
'admin.tags.store','admin.tags.show','admin.tags.edit','admin.tags.update','admin.tags.destroy','storage.local',);
        registerArgumentsSet('views', 
'app','emails.newsletter-confirmation','emails.newsletter-new-post','mail.test-mail','horizon::layout',
...
'validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','de.0','en.0',
'pl.0',);
        registerArgumentsSet('env', 
'COMPOSE_BAKE','COMPOSE_PROJECT_NAME','APP_NAME','APP_ENV','APP_KEY',
...
'VITE_APP_NAME','APP_AVAILABLE_LOCALES','SCOUT_QUEUE','SCOUT_DRIVER','SCOUT_ENABLED',
'TYPESENSE_API_KEY','TYPESENSE_HOST','TYPESENSE_PORT','SENTRY_LARAVEL_DSN','SENTRY_TRACES_SAMPLE_RATE',);
