...
// Lazy load komponentów które nie są krytyczne dla FCP
...
// Memoizowane komponenty dla lepszej wydajności
...
export default function Home({ posts }: { posts: Post[] }) {
    ...
    const handleSubscribe = React.useCallback((event: React.FormEvent) => {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            {/* Hero Section - Krytyczna sekcja dla FCP */}
            <section className="relative px-4 py-16 md:py-24 lg:py-28">
                ...
                <div className="relative z-10 mx-auto max-w-5xl">
                    {/* Renderowanie bez animacji dla krytycznej zawartości */}
                    <HeroContent __ ={__} />

                    {/* Lazy loading animacji dla przycisków */}
                    <Suspense fallback={
            ...
            {/* Newsletter Section - Lowest priority */}
            <section className="px-4 py-16">
                <div className="mx-auto max-w-5xl">
                    <Suspense fallback={
